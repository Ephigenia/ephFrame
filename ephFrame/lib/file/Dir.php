...
class_exists('IndexedArray') or require dirname(__FILE__).'/../util/IndexedArray.php';
...
class DirNotFoundException extends DirException 
{
	public function __construct($directory = null) 
	{
		if (is_object($directory)) {
			$director = $directory->nodeName;
		}
		if (empty($directory)) {
			$directory = '[empty]';
		}
		$this->message = sprintf('Directory not found: "%s".', $directory);
		parent::__construct();
	}
}
